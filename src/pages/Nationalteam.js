...
import NationalrankingItem from "../components/NationalrankingItem";
import PropTypes from "prop-types";
import styles from "./Nationalteam.module.css";

const Nationalteam = ({
  nationalteamAlignSelf,
  frameDivWidth,
  frameDivAlignSelf,
  rectangle5,
  flag,
  ...
  const nationalteamStyle = useMemo(() => {
    return {
      alignSelf: nationalteamAlignSelf,
    };
  }, [nationalteamAlignSelf]);
  ...
  return (
    <div className={styles.nationalteam} style={nationalteamStyle}>
      <div className={styles.rectangleParent} style={frameDivStyle}>
        <img className={styles.frameChild} alt="" src={rectangle5} />
          ...
          <div className={styles.nationalRangliste}>
            <div className={styles.nationalrankingitemParent}>
              ...
              <div className={styles.nationalrankingitem}>
                ...
                <img className={styles.flagIcon} alt="" src={flag5} />
...
Nationalteam.propTypes = {
  ...
  flag1: PropTypes.string,
  flag2: PropTypes.string,
  flag3: PropTypes.string,
  flag4: PropTypes.string,
  flag5: PropTypes.string,
  flag6: PropTypes.string,

  /** Style props */
  nationalteamAlignSelf: PropTypes.any,
